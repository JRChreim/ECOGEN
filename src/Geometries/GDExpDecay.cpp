...
#include "GDExpDecay.h"

using namespace tinyxml2;

//***************************************************************

GDExpDecay::GDExpDecay(std::string name, std::vector<Phase*> vecPhases, Mixture* mixture, std::vector<Transport> vecTransports, XMLElement* element, const int& physicalEntity, std::string fileName) :
...
GDExpDecay::~GDExpDecay(){}

//***************************************************************

bool GDExpDecay::belong(Coord& posElement, const int& /*lvl*/) const
{
